...
Sentinel-1 L1 is using a EW SLC mask in order to filter out some requests that are not necessary to be produced. Further information can be found under the [process configuration](/common/README.md#process-configuration).
