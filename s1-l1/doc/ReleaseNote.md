 ...
 * [RS Add-on S1 L1](#rs-add-on-s1-l1)
    * [Overview](#overview)
...
Sentinel-1 L1 is using a EW SLC mask in order to filter out some requests that are not necessary to be produced. Further information can be found under the [process configuration](/docs/common/README.md#process-configuration).
